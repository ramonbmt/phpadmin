		...
		<form class="form-horizontal well" method="POST" enctype='multipart/form-data' action="<?php echo $this->sendTo; ?>">
			<fieldset>
				...
				<div class="form-actions" >
					<button onclick="select_id(); return false;" class="btn btn-info">Agregar</button>
					<button onclick="close_window(); return false;" class="btn btn-warning">Cancelar</button>
				</div>
				<?php } ?>
			</fieldset>
		</form>
...
<script>
	...
	function select_id(){
		this_id = $('#<?php echo $this->div_id; ?>').val();
		<?php echo $this->modal->generateFunc("this_id"); ?>
	}
</script>
